...
class MainWindow(QMainWindow):
    ...
    def read_model_params(self):
        ...
        Xmin[4] = Xmin[6] = float(self.oa_int_min.text())
        Xmax[4] = Xmax[6] = float(self.oa_int_max.text())
        Xmin[5] = Xmin[7] = float(self.oa_range_min.text())
        Xmax[5] = Xmax[7] = float(self.oa_range_max.text())
